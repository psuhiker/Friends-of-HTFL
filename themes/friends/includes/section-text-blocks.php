    ...
    <div class="container">
        <div class="row">
            ...
            <?php if( have_rows('section_text_blocks_single_block') ): while ( have_rows('section_text_blocks_single_block') ) : the_row(); ?>
                ...
                <div class="block text <?php if ( $panel_count == 1 ) { ?>col-md-10 col-md-offset-1 col-lg-9 col-lg-offset-1<?php } elseif ( $panel_count == 2 ) { ?>col-md-6<?php } elseif ( $panel_count == 3 ) { ?>col-md-4<?php } ?>">
